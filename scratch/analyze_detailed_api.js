...
try {
  const reqs = JSON.parse(fs.readFileSync('/Users/m/Downloads/ELABBAR-main 3/scratch/factures_api_network.json', 'utf8'));
  console.log(`Analyzing ${reqs.length} API/XHR/Fetch responses:`);
  reqs.forEach((r, idx) => {
